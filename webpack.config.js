...
const config = {
  ...
  module: {
    rules: [
      ...
      {
        test: /\.css$/,
        include: [APP_DIR, /superset-ui.+\/src/, new RegExp('/superset-ui/plugins/plugin-chart-hello-world/node_modules/leaflet/dist/'), new RegExp('/superset-ui/plugins/legacy-plugin-chart-country-map/src/CountryMap.css') ],
        use: [
